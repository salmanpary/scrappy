  ...
  return (
    <div className="">
      ...
      <div className="flex justify-center items-center gap-2">
        ...
        <input type="text" className="bg-slate-200 h-8 rounded-sm" onChange={(e)=>{
      ...
      <div className="flex justify-start ml-16 items-center  ">
        <input type="time" className="from-date h-16 w-20" onChange={(e)=>{
          setfromtime(e.target.value)
        }}></input>
        <h4 className="mx-6 font-poppins font-bold">To</h4>
        <input type="time" className=" to-date h-16 w-20" onChange={(e)=>{
      ...
      <input type="text" className="bg-slate-200  h-8 rounded-sm" onChange={(e)=>setaddress(e.target.value)}/>
      </div>

      <div className="flex justify-center">
        <button className="bg-slate-900 text-white font-poppins   w-52  font-medium h-14 rounded-3xl mt-8 " onClick={()=>{
          submithandler()
        }}>
          Submit
        </button>
