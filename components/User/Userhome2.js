  ...
  return (
    <div className="">
      ...
      <div className="flex justify-center">
        <button className="bg-slate-900 text-white font-poppins   w-72  font-medium h-24 rounded-3xl mt-4  mb-8">
          Upload Photo
        </button>
      </div>
      ...
      <div className="flex justify-center">
        <button className="bg-slate-900 text-white font-poppins   w-52  font-medium h-14 rounded-3xl mt-8 ">
          Submit
        </button>
      </div>
